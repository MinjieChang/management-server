...
class NormalLoginForm extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Form onSubmit={this.handleSubmit.bind(this)} className="login-form">
        <FormItem>
          {getFieldDecorator('email', {
            ...
            <Input prefix={<Icon type="user" style={{ fontSize: 13 }} />} placeholder="用户名" onChange={this.textInput.bind(this)}/>
          )}
        </FormItem>
        <FormItem>
          {getFieldDecorator('password', {
            ...
            <Input prefix={<Icon type="lock" style={{ fontSize: 13 }} />} type="password" placeholder="密码" onChange={this.textInput.bind(this)}/>
          )}
        </FormItem>
        <FormItem>
      ...
      <p ref="tip" style={{position:'absolute',bottom:"95px",left:'156px',color:'red',display:'none'}}>用户名或密码错误！</p>
      </div>
    );
  }
}
